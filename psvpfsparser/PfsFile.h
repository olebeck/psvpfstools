...
private:
   ...
   int decrypt_icv_file(std::filesystem::path destination_root) const;

   int decrypt_unicv_file(std::filesystem::path destination_root) const;

public:
   int decrypt_file(std::filesystem::path destination_root) const;
};